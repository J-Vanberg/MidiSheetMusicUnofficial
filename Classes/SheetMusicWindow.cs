...
namespace MidiSheetMusic
{
    ...
    public class SheetMusicWindow : Form
    {
        ...
        public SheetMusicWindow()
        {
            ...
            // JV: Reduced default size, use minimum of 800x600
            // This is preference on my end, really should just remember
            // the last size of the window.
            Size = new Size(
                    Math.Max(bounds.Width * 1 / 2, 800),
                    Math.Max(bounds.Height * 2 / 3, 600)
                );
        ...
        MidiOptions GetMidiOptions()
        {
            ...
            options.smoothScroll = smoothScrollMenu.Checked;
        ...
        void SetMenuFromMidiOptions(MidiOptions options)
        {
            ...
            smoothScrollMenu.Checked = options.smoothScroll;
        ...
        void RedrawSheetMusic()
        {
            ...
            sheetmusic.EnableSmoothScroll = smoothScrollMenu.Checked;
        ...
        void CreateViewMenu()
        {
            ...
            smoothScrollMenu = new MenuItem(Strings.smoothScrollMenu, new EventHandler(SmoothScroll));
            smoothScrollMenu.Checked = true;
            viewMenu.MenuItems.Add(smoothScrollMenu);
            viewMenu.MenuItems.Add("-");
        ...
        /** JV: The callback function for the "Scroll Smoothly" menu. */
        void SmoothScroll(object obj, EventArgs args)
        {
            smoothScrollMenu.Checked = !smoothScrollMenu.Checked;
            sheetmusic.EnableSmoothScroll = smoothScrollMenu.Checked;
        }
        ...
        void Help(object obj, EventArgs args)
        {
            ...
            Assembly assembly = this.GetType().Assembly;
            Stream stream = assembly.GetManifestResourceStream("MidiSheetMusic.Resources.help.rtf");
